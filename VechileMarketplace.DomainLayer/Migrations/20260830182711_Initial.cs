        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AttributeId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AttributeDefinitionName = table.Column<string>(type: "text", nullable: false),
                    AttributeDataType = table.Column<string>(type: "text", nullable: false),
                    IsRequeried = table.Column<bool>(type: "boolean", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    ProductTypeId = table.Column<long>(type: "bigint", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttributeDefinition", x => x.AttributeId);
                    table.ForeignKey(
                        name: "FK_AttributeDefinition_ProductType_ProductTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellableStock = table.Column<int>(type: "integer", nullable: true),
                    DamagedStock = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PavId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ProductId = table.Column<long>(type: "bigint", nullable: false),
                    AttributeId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductAttributeValue", x => x.PavId);
                    table.ForeignKey(
                        name: "FK_ProductAttributeValue_AttributeDefinition_AttributeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeDefinition_ProductTypeId",
